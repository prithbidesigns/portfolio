...
export const DeleteButton = ({ onClick, style }) => (
  <button type="button" className="del-button" onClick={onClick} style={style}>
    <svg
...
export const EditButton = ({ onClick, style }) => (
  <button type="button" className="edi-button" onClick={onClick} style={style}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      viewBox="0 0 24 24"
...
export const VisibilityButton = ({ visible, onClick, style }) => (
  <button
    type="button"
    className="edi-button"
    onClick={onClick}
...
export const MoveButton = ({ direction, onClick, disabled, style }) => (
  <button
    type="button"
    className="edi-button"
    onClick={onClick}
...
export const AddButton = ({ onClick, buttonText, style }) => (
  <button type="button" className="ad-button" onClick={onClick} style={style}>
