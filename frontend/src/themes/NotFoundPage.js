...
const NotFoundPage = () => {
  return (
    <>
      <Helmet>
      <title>404 prithbidesigns - Page Not Found</title>
      <meta
        name="description"
        content="404 Oops! This page isn't available. Explore prithbidesigns for modern web development insights, innovative projects, and tailored digital solutions."
      />
      </Helmet>
      ...
      <meta property="og:url" content="https://portfolio-frontend-y9pr.onrender.com/404" />
